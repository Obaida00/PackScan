...
module.exports = {
  ...
  plugins: [
    new CopyWebpackPlugin({
      patterns: [
        { from: path.resolve(__dirname, "./src/process_invoice_pdf.py"), to: "./" },
        { from: path.resolve(__dirname, "./src/generate_sticker.py"), to: "./" },
        { from: path.resolve(__dirname, "./src/generate_barcode.py"), to: "./" },
        { from: path.resolve(__dirname, "./src/print_html.py"), to: "./" },
